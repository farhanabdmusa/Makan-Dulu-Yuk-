...
public class MapsActivity extends FragmentActivity implements
        ...
        switch (v.getId())
        {
            case R.id.search_address:
                ...
                if(!TextUtils.isEmpty(address))
                {
                    ...
                    try
                    {
                        ...
                        if(addressList != null)
                        {
                            for(int i=0; i< addressList.size(); i++)
                            {
                                ...
                                LatLng latLng = new LatLng(((Address) userAddress).getLatitude(), ((Address) userAddress).getLongitude());
                    ...
                    Toast.makeText(this,"Please write any restaurant name ....", Toast.LENGTH_SHORT).show();
                }
                break;
    ...
    private String getUrl(double latitude, double longitude, String restaurant)
    {
        ...
        googleURL.append("&key=" + "AIzaSyBViOCu9MMtO0PuAYEsmk5DibliiDLB6LM" );
    ...
    public boolean checkUserLocationPermission(){
        if(ContextCompat.checkSelfPermission(this, permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED)
        {
            ...
            {
                ActivityCompat.requestPermissions(this, new String[]{permission.ACCESS_FINE_LOCATION}, Request_User_Location_Code);
            }
            else
            {
                ActivityCompat.requestPermissions(this, new String[]{permission.ACCESS_FINE_LOCATION}, Request_User_Location_Code);
